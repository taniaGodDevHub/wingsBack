 ...
 *     ),
 *     @OA\Parameter(name="page", in="query", description="Номер страницы", @OA\Schema(type="integer", default=1)),
 *     @OA\Parameter(name="page_size", in="query", description="Товаров на странице", @OA\Schema(type="integer", default=60)),
 *     @OA\Parameter(name="color_ids", in="query", description="ID цветов через запятую", @OA\Schema(type="string")),
 *     @OA\Parameter(name="size_values", in="query", description="Размеры через запятую", @OA\Schema(type="string")),
 *     @OA\Parameter(name="gender", in="query", description="Пол: male, female, unisex", @OA\Schema(type="string")),
 *     @OA\Parameter(name="price_min", in="query", description="Минимальная цена", @OA\Schema(type="number")),
 *     @OA\Parameter(name="price_max", in="query", description="Максимальная цена", @OA\Schema(type="number")),
 *     @OA\Parameter(name="sort_by", in="query", description="Сортировка", @OA\Schema(type="string")),
 *     @OA\Parameter(name="sort_order", in="query", description="Направление сортировки", @OA\Schema(type="string")),
 *     @OA\Response(
 *         response=200,
