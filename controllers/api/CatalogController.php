 ...
 *     description="Баннеры, блок «О нас», блок «Благо», категории по полу и нижний баннер"
 * )
 *
 * @OA\Get(
 *     path="/api/catalog/home",
 *     summary="Контент главной страницы",
 *     description="Возвращает баннеры слайд-шоу, блок «О нас», блок «Благо», изображения категорий (мужское/женское) и нижний баннер. Авторизация не требуется. Для загрузки только визуального контента главной предпочтительнее этот эндпоинт; тот же набор полей также дублируется в ответе `/api/catalog/showcase`.",
 *     operationId="catalogHomeContent",
 *     tags={"Главная страница"},
 *     @OA\Response(
 *         response=200,
 *         description="Баннеры, блок «О нас», блок «Благо», категории и нижний баннер главной",
...
- `attributes` — атрибуты товара и выбранные значения (Материал, Сезон и т.д.; цвет — в `color`);
