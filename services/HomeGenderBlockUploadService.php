...
final class HomeGenderBlockUploadService
{
    ...
    {
        return Yii::getAlias('@uploads/home-categories');
    }

    public function upload(HomeGenderBlock $block, UploadedFile $file): ?string
    {
        if ($file->hasError) {
        ...
        $this->removeLocalFileIfOwned($block->image_url);
        $block->image_url = 'uploads/home-categories/' . $filename;
    ...
    public function removeLocalFileIfOwned(?string $imageUrl): void
    {
        ...
        $prefix = 'uploads/home-categories/';
