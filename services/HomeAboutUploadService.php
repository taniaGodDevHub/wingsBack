...
final class HomeAboutUploadService
{
    ...
    {
        return Yii::getAlias('@uploads/about');
    }

    public function upload(HomeAbout $about, UploadedFile $file): ?string
    {
        if ($file->hasError) {
        ...
        $filename = sprintf('about_%s.%s', bin2hex(random_bytes(8)), $extension);
        ...
        $this->removeLocalFileIfOwned($about->image_url);
        $about->image_url = 'uploads/about/' . $filename;
